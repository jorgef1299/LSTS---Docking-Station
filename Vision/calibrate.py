...
# # # # # # # # # # # # # # # # # # # # # # # # # # # 
#                                                   #
#  This is code was adapted from:                   #
#  https://github.com/dronedojo/video2calibration/  #
#                                                   #
# # # # # # # # # # # # # # # # # # # # # # # # # # # 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--debug_dir',nargs="?", help='path to directory where images with detected chessboard will be written',
                        default='./pictures')
    parser.add_argument('--output_dir',nargs="?",help='path to directory where calibration files will be saved.',default='./calibration_files')
